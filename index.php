...
<html lang="es" dir="ltr">
    ...
    <body>
        <div class="main-wrapper">
            ...
            <!-- Login box.scss -->
            <!-- ============================================================== -->
            <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background-color:#005ea6; background:url(assets/images/background/login03.jpg) no-repeat center center; background-size: cover;">
                <div class="auth-box on-sidebar" style="background-color:#e4f1fa;">
                    <div id="loginform">
                        <div class="logo">
                            <span class="db"><img src="assets/images/logo_menu01.png" style="height:99px;" alt="Acceso al Sistema" /></span>
                        </div>
                        <!-- Form -->
                        <div class="row">
                            <div class="col-12">
