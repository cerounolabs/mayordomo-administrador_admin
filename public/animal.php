                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <h4 class="col-2 card-title" style="text-align: right;">
                                        <a href="javascript:void(0)" onclick="setAnimal(<?php echo $valueDominio; ?>, 'var01', 0, 'animal.php?especie=<?php echo $valueDominio; ?>', 1);" title="Nuevo" class="btn btn-info" style="background-color:#005ea6; border-color:#005ea6;" role="button" data-toggle="modal" data-target="#modal-dialog"><i class="ti-plus"></i></a>
                                	</h4>
								</div>
