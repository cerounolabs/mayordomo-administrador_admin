                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <h4 class="col-10 card-title">DEPARTAMENTO</h4>
                                    <h4 class="col-2 card-title" style="text-align: right;">
                                        <a href="javascript:void(0)" onclick="setDepartamento(0, 1);" title="Nuevo" class="btn btn-info" style="background-color:#005ea6; border-color:#005ea6;" role="button" data-toggle="modal" data-target="#modal-dialog"><i class="ti-plus"></i></a>
                                	</h4>
								</div>
