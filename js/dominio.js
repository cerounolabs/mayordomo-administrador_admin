$(document).ready(function() {
	...
	var urlDominio	= 'https://www.cerouno.me/mayordomo_api/public/v1/default/000/dominio/'+codigo;
	...
	$('#tableLoad').DataTable({
		...
		columns		: [
			{ render			: function (data, type, full, meta) {return '<a href="../public/dominio_crud.php?dominio='+ full.tipo_dominio +'&mode=R&codigo=' + full.tipo_codigo + '" role="button" class="btn btn-primary" title="Ver"><i class="ti-eye"></i>&nbsp;</a>&nbsp;<a href="../public/dominio_crud.php?dominio='+ full.tipo_dominio +'&mode=U&codigo=' + full.tipo_codigo + '" role="button" class="btn btn-success" title="Editar"><i class="ti-pencil"></i>&nbsp;</a></a>&nbsp;<a href="../public/dominio_crud.php?dominio='+ full.tipo_dominio +'&mode=D&codigo=' + full.tipo_codigo + '" role="button" class="btn btn-danger" title="Eliminar"><i class="ti-trash"></i>&nbsp;</a>';}},
