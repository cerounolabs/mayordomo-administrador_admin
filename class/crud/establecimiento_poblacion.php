		...
		if (isset($var101) && isset($var102) && isset($var103) && isset($var104_1) && isset($var104_2) && isset($var106) && $var106 > 0) {
			$dataJSON = json_encode(
				array(
					...
					'establecimiento_persona_codigo'			=> $var101,
			...
			switch($work02){
				case 'C':
					$result	= post_curl('establecimiento/500/poblacion', $dataJSON);
					break;
				case 'U':
					$result	= post_curl('establecimiento/500/poblacion', $dataJSON);
					break;
				case 'D':
					$result	= delete_curl('establecimiento/500/poblacion/'.$work04, $dataJSON);
					break;
			}
